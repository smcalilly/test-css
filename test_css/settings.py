...
from test_css.logging import before_send
...
ROOT_URLCONF = 'test_css.urls'

TEMPLATES = [
    {
        'BACKEND': 'django.template.backends.django.DjangoTemplates',
        'DIRS': ['templates/', 'templates/test_css'],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
                ...
                'test_css.context_processors.base_context',
            ],
        },
    },
]

WSGI_APPLICATION = 'test_css.wsgi.application'
